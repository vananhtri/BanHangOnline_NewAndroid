...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            // handel the đăng nhập action
            FragDangNhap fragDangNhap= new FragDangNhap();
            FragmentManager manager= getSupportFragmentManager();
            manager.beginTransaction().replace(R.id.main_contents, fragDangNhap, fragDangNhap.getTag()).addToBackStack(null).commit();
        }
        else if (id == R.id.nav_DoiMatKhau) {
            FragDoiMatKhau fragDoiMatKhau= new FragDoiMatKhau();
            FragmentManager manager= getSupportFragmentManager();
